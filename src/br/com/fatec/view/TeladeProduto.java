...
public class TeladeProduto extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TeladeProduto
     */
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addComponent(txtFornecedor, javax.swing.GroupLayout.PREFERRED_SIZE, 182, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        Persistencia.listaProdutos.add(new Produto(codigo, nome, fornecedor));
    ...
    private void btnListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarActionPerformed
        ...
        listaProdutosCadastrados = Persistencia.getListaProdutos();
        
        DefaultTableModel tabelaProdutos = (DefaultTableModel)tableProdutos.getModel();
        tabelaProdutos.setRowCount(0);
        
                for (Produto user : listaProdutosCadastrados) {
            Object[] linha={user.getCodigo(),user.getNome(),user.getFornecedor()};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeladeProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
